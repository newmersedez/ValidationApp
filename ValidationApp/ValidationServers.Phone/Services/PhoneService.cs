...
public class ValidationPhoneService : ValidationPhone.ValidationPhoneBase
{
    ...
    {
        _rabbit_model.QueueDeclare(queue: "phone", durable: false, exclusive: false, autoDelete: false, arguments: null);
        ...
        _rabbit_model.BasicPublish(exchange: "", routingKey: "phone", basicProperties: null, body: body);
        _rabbit_model.BasicConsume(queue: "phone", autoAck: true, consumer: _consumer);
