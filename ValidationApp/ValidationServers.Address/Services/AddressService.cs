...
using ValidationServers.Address.Context;
...
public class ValidationAddressService : ValidationAddress.ValidationAddressBase
{
    ...
    public ValidationAddressService()
    {
        container.Register<IValidator, AddressValidator>();
    ...
    {
        _rabbit_model.QueueDeclare(queue: "address", durable: false, exclusive: false, autoDelete: false, arguments: null);
        ...
        _rabbit_model.BasicPublish(exchange: "", routingKey: "address", basicProperties: null, body: body);
        _rabbit_model.BasicConsume(queue: "address", autoAck: true, consumer: _consumer);
